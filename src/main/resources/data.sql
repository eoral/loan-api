...
insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (1, 1, 30000, 30000, '2025-06-01', '2025-06-01', true);
insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (2, 1, 30000, 30000, '2025-07-01', '2025-07-01', true);
insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (3, 1, 30000, null, '2025-08-01', null, false);
insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (4, 1, 30000, null, '2025-09-01', null, false);
