...
insert into loan (id, customer_id, loan_amount, number_of_installment, create_date, is_paid)
  values (1, 1, 100000, 4, '2025-05-01T12:00:00+00:00', false);
select next value for loan_seq;

insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (1, 1, 26000, 26000, '2025-06-01T12:00:00+00:00', '2025-06-01T12:00:00+00:00', true);
insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (2, 1, 26000, 26000, '2025-07-01T12:00:00+00:00', '2025-07-01T12:00:00+00:00', true);
insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (3, 1, 26000, 26000, '2025-08-01T12:00:00+00:00', null, false);
insert into loan_installment (id, loan_id, amount, paid_amount, due_date, payment_date, is_paid)
  values (4, 1, 26000, 26000, '2025-09-01T12:00:00+00:00', null, false);
